...
<div class="content-wrapper" style="background-image: url('<?php echo base_url('upload/1.jpg') ?>');height: 100%; background-position: center;
    ...
    <form action="<?php echo base_url('Admin/fuarekle'); ?>" role="form" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="card card-primary">
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    <label for="inputName">Fuar Başlık Giriniz</label>
                                    <input type="text" name="f_baslik1" class="form-control" required>
                                </div>
                                <div class="form-group">
                                    <label for="inputName">Başlık Giriniz</label>
                                    <input type="text" name="f_baslik2" class="form-control" required>
                                </div>
                                <div class="form-group">
                                    <label for="inputName">Açıklama Giriniz</label>
                                    <textarea id="u_aciklama" name="f_aciklama" class="form-control" required></textarea>
                                </div>
