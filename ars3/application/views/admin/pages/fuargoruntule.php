						...
						<table id="banka" class="table table-bordered table-striped" style="width:100%">
							...
							<tbody>
								<?php foreach ($fuar as $fuarogeleri) { ?>
									<tr>
										<td>
											<p><?php echo $fuarogeleri->f_baslik1; ?></p>
										</td>
										<td>
											<p><?php echo $fuarogeleri->f_baslik2; ?></p>
										</td>
                                        <td>
											<p><?php echo $fuarogeleri->f_aciklama; ?></p>
										</td>
                                        <td>
											<p><?php echo $fuarogeleri->f_resim; ?></p>
										</td>
										
										<td>
                                            <a href="<?php echo base_url('Admin/fuarduzenleindex/' . $fuarogeleri->id . ''); ?>" class="btn btn btn-success"><i class="fa fa-edit"></i>Düzenle</a>
											...
											<div class="modal fade" id="modal-danger-<?php echo $fuarogeleri->id; ?>">
												<div class="modal-dialog">
													<div class="modal-content">
														<div class="modal-header">
															<h4 class="modal-title"><?php echo $fuarogeleri->f_baslik1; ?> </h4>
														...
														<div class="modal-footer justify-content-between">
															...
															<a href="<?php echo base_url('Admin/fuarsil/'.$fuarogeleri->id.''); ?>" class="button"><button type="button" class="btn btn-outline-danger">Evet</button></a>
														</div>
													</div>
												</div>
											</div>
