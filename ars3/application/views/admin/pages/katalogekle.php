...
<div class="content-wrapper" style="background-image: url('<?php echo base_url('upload/1.jpg') ?>');height: 100%; background-position: center;
    ...
    <form action="<?php echo base_url('Admin/katalogekle'); ?>" role="form" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="card card-primary">
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    <label for="inputName">Katalog Başlık Giriniz</label>
                                    <input type="text" name="k_baslik" class="form-control" required>
                                </div>
                    ...
                    <div class="card card-primary">
                        <div class="card-body">
                            <div class="form-group">
                                ...
                                <input type="file" name="k_dosya" class="form-control">
                            </div>
