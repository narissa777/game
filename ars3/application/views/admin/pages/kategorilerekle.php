...
<div class="content-wrapper" style="background-image: url('<?php echo base_url('upload/1.jpg') ?>');height: 100%; background-position: center;
    ...
    <form action="<?php echo base_url('Admin/kategorilerekle'); ?>" role="form" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="card card-primary">
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="k_ad" class="form-control" required>
                                </div>
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="card card-primary">
                        <div class="card-body">
                            <div class="form-group">
                                <label for="inputName">Kart İçin Resim 1(En ve Boy oranı maximum 450X520 olarak seçilmeli ve en iyi görüntü için en ve boy eşit olan kare fotoğraflar seçilmelidir)</label>
