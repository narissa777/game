...
<div class="content-wrapper" style="background-image: url('<?php echo base_url('upload/1.jpg') ?>');height: 100%; background-position: center;
    ...
    <form action="<?php echo base_url('Admin/contactduzenle'); ?>" role="form" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="card card-primary">
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea id="" name="adres" class="form-control" required><?php echo $contact[0]->adres; ?></textarea>
                                </div>
                                
                               
                                <div class="form-group">
                                    <label for="inputName">Açıklama Giriniz</label>
                                    <textarea id="" name="mail" class="form-control" required><?php echo $contact[0]->mail; ?></textarea>
                                </div>
                                ...
                                <div class="form-group">
                                    <label for="inputName">Açıklama Giriniz</label>
                                    <textarea id="" name="telefon1" class="form-control" required><?php echo $contact[0]->telefon1; ?></textarea>
                                </div>

                                <div class="form-group">
                                    <label for="inputName">Açıklama Giriniz</label>
                                    <textarea id="" name="telefon2" class="form-control" required><?php echo $contact[0]->telefon2; ?></textarea>
                                </div>
